...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-n-gKbwkp.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BfQTRcQX.js"),
		import("./start-BinPXNPa.js"),
		Promise.resolve().then(() => empty_plugin_adapters_exports)
	]);
	return {
		routerEntry,
		startEntry,
...
//#endregion
export { createStart as n, createMiddleware as r, server_exports as t };
